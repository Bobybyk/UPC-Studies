...
class MonAdapter(var students : MutableList<Etudiant>, var couleurPair : Int, var couleurImpair : Int, var couleurChecked : Int) : RecyclerView.Adapter<MonAdapter.VH>() {
