...
void PROGRAM0_body__(PROGRAM0 *data__) {
  ...
  __SET_VAR(data__->TP0.,IN,,(!(__GET_VAR(data__->CONTROL,)) && __GET_VAR(data__->INPUT,)));
  __SET_VAR(data__->TP0.,PT,,__time_to_timespec(1, 0, 5, 0, 0, 0));
  TP_body__(&data__->TP0);
  __SET_VAR(data__->,RED,,__GET_VAR(data__->TP0.Q,));
  __SET_VAR(data__->TP1.,IN,,(((!(__GET_VAR(data__->GREEN,)) && !(__GET_VAR(data__->RED,))) && __GET_VAR(data__->INPUT,)) || __GET_VAR(data__->CONTROL,)));
  __SET_VAR(data__->TP1.,PT,,__time_to_timespec(1, 0, 3, 0, 0, 0));
  TP_body__(&data__->TP1);
  __SET_VAR(data__->,YELLOW,,__GET_VAR(data__->TP1.Q,));
  __SET_VAR(data__->TP2.,IN,,(((!(__GET_VAR(data__->RED,)) && !(__GET_VAR(data__->YELLOW,))) && __GET_VAR(data__->INPUT,)) || __GET_VAR(data__->CONTROL,)));
  __SET_VAR(data__->TP2.,PT,,__time_to_timespec(1, 0, 5, 0, 0, 0));
  TP_body__(&data__->TP2);
  __SET_VAR(data__->,GREEN,,__GET_VAR(data__->TP2.Q,));
  __SET_VAR(data__->TP3.,IN,,(((!(__GET_VAR(data__->YELLOW,)) && !(__GET_VAR(data__->GREEN,))) && !(__GET_VAR(data__->RED,))) && __GET_VAR(data__->INPUT,)));
  __SET_VAR(data__->TP3.,PT,,__time_to_timespec(1, 0, 3, 0, 0, 0));
  TP_body__(&data__->TP3);
  __SET_VAR(data__->,CONTROL,,__GET_VAR(data__->TP3.Q,));
