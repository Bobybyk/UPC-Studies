...
def puissance_matrice_2_2 (M, n) :
  ...
  if n == 1 : return M
  if n%2 == 0 : return puissance_matrice_2_2(produit_matrice_2_2 (M, M), n//2)
  return produit_matrice_2_2(puissance_matrice_2_2(produit_matrice_2_2 (M, M), n//2), M)
