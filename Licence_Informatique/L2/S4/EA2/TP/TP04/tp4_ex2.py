...
def hauteur(arbre, r=None):
  ...
  if estVide(arbre) : return -1
  if r is None : r = racine(arbre)
  if estFeuilleVide(arbre, r) : return 0

  g = d = -1
  if not estFeuilleVide(arbre, filsGauche(arbre, r)) :
    g = hauteur(arbre, filsGauche(arbre, r))

  if not estFeuilleVide(arbre, filsDroit(arbre, r)) :
    d = hauteur(arbre, filsDroit(arbre, r))
